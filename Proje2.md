...
###### tek eleman kalana kadar dizimizi ikiye bölüyoruz ve bölünen dizileri tekrar bölüyoruz.
...
sürekli kendini çağırarak diziyi hep ikiye bölmektedir çünkü Recursive bir fonksiyondur. Her bölünmüş dizinin Merge işlemi için de dizinin uzunluğu olan n işlem yapıldığından O(n*(logn)) --> O(6*(log6)) olacaktır.
